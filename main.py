...
# REHAN LOVES ZOE - 75-PAGE DARK MEGA EDITION
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Love for Zoe Verma ❤️</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; cursor: none; -webkit-tap-highlight-color: transparent; }
        ...
        .glass-overlay {
            ...
            background: rgba(0, 0, 0, 0.65); /* Darker Overlay for Dark Theme */
...
<body>
    ...
    <script>
        ...
        const story = [
            // (Previous 50 stories combined + 25 New)
        ...
        setInterval(() => {
            createParticle('❤️'); // Hearts
            createParticle('★'); // Stars
